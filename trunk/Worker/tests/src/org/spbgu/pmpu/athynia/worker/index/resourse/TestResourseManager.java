...
import org.spbgu.pmpu.athynia.worker.index.ResourseManagerFactory;


/**
 * This class contains all Unit tests for {@link org.spbgu.pmpu.athynia.worker.index.ResourseManager}.
 */

public class TestResourseManager extends TestCase {


    public TestResourseManager(String name) {
...

    {
        ...
        recman = ResourseManagerFactory.createResourseManager(TestRecordFile.testFileName);
...

    {
        ...
        recman = new LocalResourseManager(TestRecordFile.testFileName);
    ...
    public static void main(String[] args) {
        ...
        junit.textui.TestRunner.run(new TestSuite(TestResourseManager.class));
