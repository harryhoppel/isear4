...
public class TestInsertPerf {
    ...
    public void insert()
        ...
        recman = ResourseManagerFactory.createResourseManager("TestInsertPref-" + System.currentTimeMillis(), props);
        ...
        // btree = BTree.createInstance( resourse, new LongComparator(),
        //                               LongSerializer.INSTANCE, IntegerSerializer.INSTANCE );

        start = System.currentTimeMillis();
        for (int i = 0; i < _numberOfObjects; i++) {
            btree.insert((long) i, i, false);
        }
        recman.commit();
